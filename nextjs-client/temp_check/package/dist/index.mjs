...
var SOGridCore = class {
  ...
  createTableInstance() {
    ...
    return createTable({
      ...
      getSortedRowModel: this.options.sortable !== false ? getSortedRowModel() : void 0,
      getFilteredRowModel: this.options.filterable !== false ? getFilteredRowModel() : void 0,
      getPaginationRowModel: this.options.pagination ? getPaginationRowModel() : void 0,
